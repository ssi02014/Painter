...
function createPainter(parent, width, height) {
	// 타이틀
	var title = elt("h2", {class: "sub_title"}, "Simple Painter");
...
function createCanvas(canvasWidth,canvasHeight) {
    var canvas = elt("canvas", { width: canvasWidth, height: canvasHeight, class: "canvas" });
...
controls.painter = function(ctx) {
	...
	var label = elt("label", {class:"paint_tool"}, "Paint Tools : ", select);
...
controls.color = function(ctx) {
	...
	var label = elt("label",{class:"controls_color"} , " Color：", input);
...
controls.brushsize = function(ctx) {
	...
	var label = elt("label",{class:"brush_size"}," BrushSize：",select);
	select.addEventListener("change", function(e) {
...
controls.alpha = function(ctx) {
	...
	var label = elt("label",{class:"transparency"} , " Transparency：", input);
